...
- [x] Publish host support, measured limits, known issues, migration/rollback instructions, and release checklists. Keep optional Cloud and explicit v1 non-goals out of local release blockers. — [docs/release.md](../release.md) (2026-09-13) publishes the host matrix, measured limits with their evidence, known issues, migration and rollback through portable export/restore, and the command checklist; Cloud and OCR are named as deferred, not blockers. The measured limits are updated as the 1M-message run completes.
