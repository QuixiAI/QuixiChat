...
Completed plans: **02, 03, 14, 16, 17, 18, 20 and 22** (canonical contracts and storage,
document extraction/search, embedding reference, scalar encoder, SIMD and bounded
embedding scheduler, compressed large-index retrieval). Plans **01, 04, 05, 06, 07, 08, 09, 10, 11, 13, 19, 21 and 23** have work underway
...
Latest completed iteration (2026-09-12): **1M browser measurement; plan 22
