...
Latest completed iteration (2026-09-12): **first-run onboarding and storage
...
Next concrete slice: **measure retrieval relevance of the production
256-token structural chunker on the plan 16 corpus** (`perf/retrieval`),
recording production-chunking parity against the reference baseline; this
closes plan 21's remaining measurement item and is the design-review input
for plan 22 (compressed vector retrieval), whose research and design review
follow. Then plan 12 (compare, critique, bulk migration), whose prerequisites
(08, 10) are in place. Plan 13's themes and accessibility audit, plan 11's real
