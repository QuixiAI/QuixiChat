...
Completed plans: **02, 03, 08, 12, 14, 16, 17, 18, 20, 22 and 23** (canonical contracts and storage,
the shared chat and library UI, compare/critique/bulk migration, document extraction/search, embedding reference, scalar
encoder, SIMD and bounded embedding scheduler, compressed large-index retrieval, diagnostics and recovery). Plans **01, 04, 05, 06, 07, 09, 10, 11, 13, 19 and 21** have work underway
for platform qualification, imports, host adapters, providers, lexical search,
archives, provider switching, browser-extension import, WebGPU release qualification and semantic search. One other in-scope plan remains planned; OCR and the two Cloud plans are deferred. Detailed evidence and
...
Latest completed iteration (2026-09-12): **cross-host restore** (plan 09).
