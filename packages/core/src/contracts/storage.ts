...
export function assertStorageRequest(request: StorageRequest): void {
  ...
  switch (request.operation) {
    ...
    case 'readLocalPreferences': case 'setSendKey': case 'setInteractionPreferences': case 'setOnboardingState': assertPreferenceArgs(request.operation, request.args); break;
