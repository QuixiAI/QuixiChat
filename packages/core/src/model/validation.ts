...
const schemas: Record<Exclude<keyof CanonicalHistory, "version">, Record<string, Check>> = {
  ...
  events: { id: isQuixiId, threadId: isQuixiId, type: choices("ProviderSwitch", "AutomaticFallback", "ContextCompaction", "ImportWarning", "Migration", "UserNote"), createdAt: nullable(integer), recordedAt: integer, messageId: nullable(isQuixiId), generationId: nullable(isQuixiId), details: jsonObject },
