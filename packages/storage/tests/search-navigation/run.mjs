...
if (!tests.length) throw new Error("No search navigation tests found.");
...
const files = [
  ...
  "packages/storage/src/worker/search/navigation.ts",
  ...
  "packages/storage/tests/search-navigation/repository.test.ts",
  "packages/storage/tests/search-navigation/run.mjs",
...
const result = {
  ...
  metrics,
  evidenceScope:
    "Pinned SQLite WASM in Node memory VFS with real canonical/extraction/search repositories and indexed FTS navigation metadata lookup. Original blob availability is an injected proof check; no PDF parser runs here. No production StorageClient, OPFS, browser-owner termination or app integration claim.",
};
